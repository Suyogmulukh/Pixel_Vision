...
const Page1Button = () => {
  return (
    <div className='absolute left-0 p-10 flex items-end justify-between bottom-0 w-full'>
        ...
        <div className='mb-28 ml-[840px]'>
            <h2  className=' text-xl font-[anzo2] text-gray-600 relative'>
            Fix dark images, improve detail, and increase <br/>
            contrast and brightness with our<br/>
            easy image enhancer ...</h2>
        </div>
      <Link to= '/uploadImage' className=' w-48 h-12 mb-8 pl-10 pt-3 bg-black rounded-2xl text-slate-50 text-sm font-medium absolute ml-[900px]  hover:text-cyan-200'> TRY Pixel Vision </Link>
    </div>
  )
}

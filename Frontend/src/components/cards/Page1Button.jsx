...
const Page1Button = () => {
  return (
    <div className='absolute left-0 p-10 flex items-end justify-between bottom-0 w-full'>
      ...
      <Link to= '/uploadImage' className=' w-48 h-12 mb-8 pl-10 pt-3 bg-black rounded-2xl text-slate-50 text-sm font-medium absolute ml-[900px] '> TRY Pixel Vision </Link>
    </div>
  )
}

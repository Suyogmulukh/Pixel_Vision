...
const sharpener = async (filepath, filterType, outputDir = 'processed') => {
  ...
  const getSharpeningKernel = (type) => {
    const kernels = {
      'low': { kernel: [[0, -0.3, 0], [-0.3, 2.2, -0.3], [0, -0.3, 0]], contrast: 0.2 },
      'medium': { kernel: [[0, -0.5, 0], [-0.5, 3.0, -0.5], [0, -0.5, 0]], contrast: 0.5 },
      'high': { kernel: [[-0.1, -0.6, -0.1], [-0.6, 4.8, -0.6], [-0.1, -0.6, -0.1]], contrast: 0.8 },
      'unblur-light': { kernel: [[-1, -1, -1], [-1, 9, -1], [-1, -1, -1]], contrast: 0.3 },
      'unblur-medium': { kernel: [[-1, -1, -1], [-1, 12, -1], [-1, -1, -1]], contrast: 0.4 },
      'unblur-strong': { kernel: [[-2, -2, -2], [-2, 20, -2], [-2, -2, -2]], contrast: 0.5 }
    };
